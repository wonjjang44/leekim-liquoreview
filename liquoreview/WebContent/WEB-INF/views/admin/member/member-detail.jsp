<%@page import="com.liquoreview.model.domain.member.MemberPw"%>
...
<%
	Member member = null;
	MemberPw memberPw = new MemberPw();
	BirthSetter birth = null;
	if(request.getAttribute("member") != null && request.getAttribute("birth") != null) {
					...
					<div class="col-md-8">
						<div class="card card-user">
							<div class="card-header">
								<h5 class="card-title">회원 상세 정보 관리</h5>
							</div>
							<div class="card-body">
								<form>
									<div class="row">
