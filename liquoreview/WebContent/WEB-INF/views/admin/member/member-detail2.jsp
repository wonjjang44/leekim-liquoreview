...
//==========================================================
function initBirth(){
	let birthStr = "<c:set var="birth" target="${memberDetail}" property="birth"/>";
	console.log(birthStr);
	//$("select[name='birthYear']").val(birthStr.substring(0, 4));
	//$("select[name='birthMonth']").val(birthStr.substring(5, 7));
	//$("select[name='birthDate']").val(birthStr.substring(8, 10));
	//console.log($(select[name='birthYear']).val());
	//console.log($(select[name='birthMonth']).val());
	//console.log($(select[name='birthDate']).val());
}
										...
										<div class="col-md-8 pr-1">
											<div class="form-group">
												<label>연락처</label> <input type="text" 
													...
													disabled name="phonenum" value="${memberDetail.phonenum }">
											</div>
										</div>
									</div>
									<div class="row">
										<div class="col-md-3">
											<div class="form-group">
												...
												<select class="form-control" name="birthYear" disabled>
													<%-- <c:forEach items = "${birth.yearList }" var="year">
										...
										<div class="col-md-3">
											<div class="form-group">
												...
												<select class="form-control" name="birthMonth" disabled>
													<%-- <c:forEach items="${birth.monthList }" var="month">
										...
										<div class="col-md-3">
											<div class="form-group">		
												...
												<select class="form-control" name="birthDate" disabled>
													<%-- <c:forEach items="${birth.dateList }" var="date">
														<c:choose>
															<c:when test="${date <10}">
